    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="?page=maintenance">
          ...
          <span>Barang Maintenance</span></a>
      </li>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item" href="?page=barangmasuk">Barang Kembali</a>
            <a class="collapse-item" href="?page=barangkeluar">Barang Pinjam</a>
            <a class="collapse-item" href="?page=transaksi">Transaksi</a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_gudang">Laporan Stok Barang</a>
            <a class="collapse-item" href="?page=laporan_barangkeluar">Laporan Barang Pinjam</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
          ...
          <section class="content">
            ...
            if ($page == "member") {
              ...
              if ($aksi == "tambahmember") {
                include "page/member/tambahmember.php";
              }
              if ($aksi == "ubahmember") {
                include "page/member/ubahmember.php";
              }
              if ($aksi == "hapusmember") {
                include "page/member/hapusmember.php";
              }
            }
            ...
            if ($page == "transaksi") {
              ...
              if ($aksi == "ubahtransaksi") {
                include "page/transaksi/ubahtransaksi.php";
              }
            ...
            if ($page == "maintenance") {
              if ($aksi == "") {
                include "page/maintenance/maintenance.php";
              }
              if ($aksi == "tambahmaintenance") {
                include "page/maintenance/tambahmaintenance.php";
              }
              if ($aksi == "ubahmaintenance") {
                include "page/maintenance/ubahmaintenance.php";
              }
              if ($aksi == "hapusmaintenance") {
                include "page/maintenance/hapusmaintenance.php";
              }
            }
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; 2022 . SEMBAR EMPIRE</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
